...
> [!NOTE]
> We are rewriting [CeleScope](https://github.com/singleron-RD/CeleScope) pipelines using nextflow to achieve better scalability and reproducibility. We recommend using nf-celescope whenever possible.
