# singleron-RD/nf-celescope: Usage
...
CONTROL1,CONTRO_S1_L002_R1_001.fastq.gz,CONTRO_S1_L002_R2_001.fastq.gz
CONTROL1,CONTRO_S1_L003_R1_001.fastq.gz,CONTRO_S1_L003_R2_001.fastq.gz
CONTROL1,CONTRO_S1_L004_R1_001.fastq.gz,CONTRO_S1_L004_R2_001.fastq.gz
```
...
```
pip install nf-core
nf-core launch singleron-RD/nf-celescope
```


### Running the pipeline with test data

This pipeline contains a small test data. The test config file can be found [here](../conf/assays/).
Run the following command to test

```
nextflow run singleron-RD/nf-celescope -profile test_{assay},docker --outdir results
```
...
> [!NOTE]
> Please note that only the `docker` profile is currently supported. Other methods (Singularity, Conda, etc.) may be added in future releases.
